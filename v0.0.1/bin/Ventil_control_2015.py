...
def ST100(e):
  ...
  if inhalt == '100':
    ...
    #print "...teste ST100: " , stemp2 , ">=" , maxSolar                          # ...zum testen
    #print "...teste ST100: " , diff_ps , ">=" , max_diff_ps , "f=" , f          # ...zum testen
    if stemp2 >= maxSolar:
        print "...teste ST100: " , stemp2 , ">=" , maxSolar                     # ...zum testen
        if inhalt == '0':
        ...
        print "...teste ST100: " , diff_ps , ">=" , max_diff_ps                 # ...zum testen
        if inhalt == "0":
            print "Ventil wird von 0 auf 100 gestellt"                          # ...zum testen
            sh(VS100)
            write_Vzustand(100)
...
def ST50(e):
  ...
  if inhalt == '50':
    ...
    if diff_ps < max_diff_ps:
      print diff_ps , "<" , max_diff_ps                                         # ...zum testen
      if diff_ps >= f:
        print diff_ps , ">=" , f                                                # ...zum testen
        #if diff_sp <= max_diff_sp:
        if inhalt == "0":
...
def main():
    ...
    print '--------------------------------'
    print 'diff_ps         -> ' , diff_ps #, ' --> max_ps' , max_diff_ps
